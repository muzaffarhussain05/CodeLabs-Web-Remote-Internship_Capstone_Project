...
const GetTouch = () => {
  ...
  return (
    <>
      <div
        className="md:mt-40 py-4 md:py-10 mt-15 flex flex-col justify-center items-center md:gap-11 gap-6 "
        // style={{
      ...
      >
        ...
        <div>
          {" "}
          <button className="cursor-pointer flex gap-4 items-center justify-between overflow-hidden rounded-full border border-black/30 bg-black/20 text-sm   pl-6 pr-4    text-black/80 font-semibold opacity-85 backdrop-blur-xs transition-all hover:bg-transparent py-2.5 dark:border-white/10 dark:bg-white/1  ">
            Get in Touch{" "}
